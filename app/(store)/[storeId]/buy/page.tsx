  ...
  return (
    <div className="flex ">
      ...
      <div className="w-full h-screen bg-gray-50  gap-x-4 p-4 flex flex-col gap-y-4">
        <h1 className="text-3xl font-bold text-start  text-zinc-800">Buy</h1>
        ...
        <div className="w-full h-[300px]     grid grid-cols-3 gap-4 ">
          <div className="flex flex-col gap-y-4 items-start gap-4 w-full h-full  ">
            <h1 className="text-xl font-semibold text-zinc-800 ">Supplier</h1>
            <ListLink count={0} href="/suppliers" title="supplier" />
            <ListLink count={0} href="/suppliers group" title="supplier goup" />
          </div>

          <div className="flex flex-col gap-y-4 items-start gap-4 w-full h-full ">
            <h1 className="text-xl font-semibold  text-zinc-800 ">Buying</h1>
            <ListLink count={0} href="/suppliers" title="purchase" />
            <ListLink
              count={0}
